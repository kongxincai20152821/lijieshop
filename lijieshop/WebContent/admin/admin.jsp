...
<script type="text/javascript">
  ...
  $(function(){
	  $("#dg").datagrid({
		 idField:"admin_id",
		 url:"../adminQueryByPage",
		 queryParams:formToJson("searchform"),
				 columns:[[
					 {field:"",checkbox:true },
					 {field:"admin_id",width:100,title:"ID",align:"center" },
					 {field:"ausername",width:100,title:"管理员账号",align:"center" },
					 {field:"apwd",width:100,title:"管理员密码",align:"center" }
		         ]],
					toolbar:[
						{
							text:"新增",
  ...
  function remove(){
    ...
    function update(){
        ...
        //表单提交 会获取表单的所有信息
	    $('#ff').form('submit',{
				url:'../adminUpdate?id='+selectedRow.id, //selectedRow.empno 获取选中行的数据id
...
<div style="">
   <form  id="searchform" method="post" style="text-align:center;padding:5px">
		   <a id="research_btn" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-reload'" style="width:130px;position:relative;float:left">清空查询条件</a>
		      管理员账号：<input class="easyui-textbox" name="qusername"  style="width:100px"> 
		      管理员密码：<input class="easyui-textbox" name="qpassword" style="width:100px"> 
...
<div id="addDialog" class="easyui-dialog" style="top:100px;padding:20px"   data-options="iconCls:'icon-save',resizable:true,modal:true,closed:true"  >
  <form action="" method="post" id="zz" style="">
       <table>
			<tr><td>管理员账号：</td><td><input name="ausername" class="easyui-textbox" data-options="required:true"></td></tr>
			<tr><td>管理员密码：</td><td><input name="apwd" class="easyui-textbox" data-options="required:true"></td></tr>
       </table>
  </form>
</div>
<!-- 修改弹窗 -->
<div id="editDialog" class="easyui-dialog" style="top:100px;padding:20px"   data-options="iconCls:'icon-save',resizable:true,modal:true,closed:true"  >
  <form  method="post" id="ff">
     <table>
			<tr><td>管理员ID：</td><td><input name="admin_id" class="easyui-textbox" data-options="required:true"></td></tr>
			<tr><td>管理员账号：</td><td><input name="ausername" class="easyui-textbox" data-options="required:true"></td></tr>
			<tr><td>管理员密码：</td><td><input name="apwd" class="easyui-textbox" data-options="required:true"></td></tr>
       </table>
  </form>
