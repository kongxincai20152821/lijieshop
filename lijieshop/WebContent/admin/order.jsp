...
<script type="text/javascript">
  ...
  $(function(){
	  $("#dg").datagrid({
		 idField:"order_id",
		 url:"../orderQueryByPage",
		 queryParams:formToJson("searchform"),
		 columns:[[
			 {field:"",checkbox:true },
			 {field:"order_id",width:100,title:"订单ID",align:"center" },
			 {field:"user_id",width:100,title:"用户ID",align:"center" },
			 {field:"username",width:100,title:"用户名称",align:"center" },
			 {field:"trueName",width:100,title:"用户真实名称",align:"center" },
			 {field:"IDcardNo",width:100,title:"用户ID号码",align:"center" },
			 {field:"order_username",width:100,title:"订单名称",align:"center" },
			 {field:"recevieName",width:100,title:"收单人名称",align:"center" },
			 {field:"address",width:100,title:"订单地址",align:"center" },
			 {field:"phone",width:100,title:"联系电话",align:"center" },
			 {field:"orderDate",width:100,title:"订单日期",align:"center" },
			 {field:"message",width:100,title:"订单客户留言",align:"center" },
			 {field:"price",width:100,title:"订单价格",align:"center" }
         ]],
			toolbar:[
				{
					text:"新增",
  ...
  function remove(){
    ...
    function update(){
        ...
        //表单提交 会获取表单的所有信息
	    $('#ff').form('submit',{
				url:'../orderUpdate?id='+selectedRow.order_id, //selectedRow.empno 获取选中行的数据id
...
<div style="">
   <form  id="searchform" method="post" style="text-align:center;padding:5px">
		   <a id="research_btn" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-reload'" style="width:130px;position:relative;float:left">清空查询条件</a>
		      订单ID：<input class="easyui-textbox" name="qOrderId"  style="width:100px"> 
...
<div id="addDialog" class="easyui-dialog" style="top:100px;padding:20px"   data-options="iconCls:'icon-save',resizable:true,modal:true,closed:true"  >
  <form action="" method="post" id="zz" style="">
       <table>
			...
			<tr><td>订单名称：</td><td><input name="username" class="easyui-textbox" data-options="required:true"></td></tr>
			<tr><td>接收人姓名：</td><td><input name="recevieName" class="easyui-textbox" data-options="required:true"></td></tr>
			<tr><td>订单地址：</td><td><input name="address" class="easyui-textbox" data-options="required:true"></td></tr>
			<tr><td>联系电话：</td><td><input name="phone" class="easyui-textbox" data-options="required:true"></td></tr>
			<tr><td>订单日期：</td><td><input name="orderDate" class="easyui-datebox" data-options="required:true"></td></tr>
			<tr><td>客户留言：</td><td><input name="message" class="easyui-textbox" data-options="required:true"></td></tr>
       </table>
  </form>
</div>
<!-- 修改弹窗 -->
<div id="editDialog" class="easyui-dialog" style="top:100px;padding:20px"   data-options="iconCls:'icon-save',resizable:true,modal:true,closed:true"  >
  <form  method="post" id="ff">
     <table>
			<tr><td>订单ID：</td><td><input name="order_id" class="easyui-textbox" data-options="required:true"></td></tr>
			<tr><td>用户ID：</td><td><input name="user_id" class="easyui-textbox" data-options="required:true"></td></tr>
			<tr><td>订单名称：</td><td><input name="username" class="easyui-textbox" data-options="required:true"></td></tr>
			<tr><td>接收人姓名：</td><td><input name="recevieName" class="easyui-textbox" data-options="required:true"></td></tr>
			<tr><td>订单地址：</td><td><input name="address" class="easyui-textbox" data-options="required:true"></td></tr>
