...
<script type="text/javascript">
  ...
  $(function(){
	  $("#dg").datagrid({
		 ...
		 queryParams:formToJson("searchform"),
				 columns:[[
					 {field:"",checkbox:true },
					 {field:"id",width:100,title:"商品类型ID",align:"center" },
					 {field:"name",width:100,title:"商品类型名称",align:"center" }
		         ]],
					toolbar:[
						{
							text:"新增",
  ...
  function remove(){
    ...
    function update(){
        ...
        //表单提交 会获取表单的所有信息
	    $('#ff').form('submit',{
				url:'../typeUpdate?id='+selectedRow.stype_id, //selectedRow.empno 获取选中行的数据id
...
<div style="">
   <form  id="searchform" method="post" style="text-align:center;padding:5px">
		   <a id="research_btn" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-reload'" style="width:130px;position:relative;float:left">清空查询条件</a>
		      商品类型ID：<input class="easyui-textbox" name="qId"  style="width:100px"> 
		      商品类型名称：<input class="easyui-textbox" name="qName" style="width:100px"> 
...
<div id="addDialog" class="easyui-dialog" style="top:100px;padding:20px"   data-options="iconCls:'icon-save',resizable:true,modal:true,closed:true"  >
  <form action="" method="post" id="zz" style="">
       <table>
			<tr><td>商品类型名称：</td><td><input name="name" class="easyui-textbox" data-options="required:true"></td></tr>
       </table>
  </form>
</div>
<!-- 修改弹窗 -->
<div id="editDialog" class="easyui-dialog" style="top:100px;padding:20px"   data-options="iconCls:'icon-save',resizable:true,modal:true,closed:true"  >
  <form  method="post" id="ff">
       <table>
			<tr><td>商品类型ID：</td><td><input name="id" class="easyui-textbox" data-options="required:true"></td></tr>
			<tr><td>商品类型名称：</td><td><input name="name" class="easyui-textbox" data-options="required:true"></td></tr>
       </table>
  </form>
</div>
