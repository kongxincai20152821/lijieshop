...
<script type="text/javascript">
  ...
  $(function(){
	  $("#dg").datagrid({
		 idField:"id",
		 url:"../orderDetailQueryByPage",
		 queryParams:formToJson("searchform"),
				 columns:[[
					 {field:"",checkbox:true },
					 {field:"id",width:100,title:"订单详细表ID",align:"center" },
					 {field:"orderID",width:100,title:"订单ID",align:"center" },
					 {field:"goods_id",width:100,title:"商品ID",align:"center" },
					 {field:"price",width:100,title:"订单价格",align:"center" },
					 {field:"number",width:100,title:"商品数量",align:"center" }
		         ]],
					toolbar:[
						{
							text:"新增",
  ...
  function remove(){
    ...
    function update(){
        ...
        //表单提交 会获取表单的所有信息
	    $('#ff').form('submit',{
				url:'../orderDetailUpdate?id='+selectedRow.id, //selectedRow.empno 获取选中行的数据id
...
<div id="addDialog" class="easyui-dialog" style="top:100px;padding:20px"   data-options="iconCls:'icon-save',resizable:true,modal:true,closed:true"  >
  <form action="" method="post" id="zz" style="">
       <table>
			<tr><td>订单ID：</td><td><input name="orderID" class="easyui-textbox" data-options="required:true"></td></tr>
			<tr><td>商品ID：</td><td><input name="goods_id" class="easyui-textbox" data-options="required:true"></td></tr>
			<tr><td>订单价格：</td><td><input name="price" class="easyui-textbox" data-options="required:true"></td></tr>
			<tr><td>商品数量：</td><td><input name="number" class="easyui-textbox" data-options="required:true"></td></tr>
       </table>
  </form>
</div>
<!-- 修改弹窗 -->
<div id="editDialog" class="easyui-dialog" style="top:100px;padding:20px"   data-options="iconCls:'icon-save',resizable:true,modal:true,closed:true"  >
  <form  method="post" id="ff">
     <table>
			<tr><td>订单详细表ID：</td><td><input name="id" class="easyui-textbox" data-options="required:true"></td></tr>
			<tr><td>订单ID：</td><td><input name="orderID" class="easyui-textbox" data-options="required:true"></td></tr>
			<tr><td>商品ID：</td><td><input name="goods_id" class="easyui-textbox" data-options="required:true"></td></tr>
			<tr><td>订单价格：</td><td><input name="price" class="easyui-textbox" data-options="required:true"></td></tr>
			<tr><td>商品数量：</td><td><input name="number" class="easyui-textbox" data-options="required:true"></td></tr>
