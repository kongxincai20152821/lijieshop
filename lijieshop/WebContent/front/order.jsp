...
<div class="container cart">
		...
		<div class="span24">
			...
			<div class="step step1">
				...
				<div class="total">
					<em id="promotion"></em>
					用户真实名称: <strong id="effectivePrice">${trueName}</strong>
				</div>
				
			<form id="orderForm" action="addOrder1" method="post">
				<div class="span24">
					<p>
					商品金额&nbsp;&nbsp;&nbsp;：<input name="allPrice" type="text" value="${allPrice }" style="width:150px;font-size:15pt;color:red" readonly="true"/>
											<span style="color:red" id="namemsg"></span>
								<br /> 
					收货人&nbsp;&nbsp;&nbsp;：<input id="name" name="recevieName" type="text" value="${trueName }" style="width:150px" />
											<span style="color:red" id="namemsg"></span>
								<br /> 
					联系方式：<input id="phone" name="phone" type="text"value="${phone }" style="width:150px" />
											<span style="color:red" id="phonemsg"></span>
					<br />
					收货地址：<input id="address" name="address" type="text" value="${address}" style="width:150px" />
										<span style="color:red" id="addressmsg"></span>
								<br />
					备&nbsp;&nbsp;注：&nbsp;&nbsp;&nbsp;&nbsp;<textarea rows="10" cols="20" name="remark"></textarea>
					<br />
					邮&nbsp;&nbsp;编:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input id="post" name="post" type="text" value="${postCode }" style="width:150px" />
						...
						<p style="text-align:right">
							...
							<a id="button" >
								<img src="front/images/finalbutton.gif" width="204" height="51" border="0" />
							</a>
						</p>
				</div>
			</form>
